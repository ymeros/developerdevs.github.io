...
const ddd_stable = [
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Susano-o',         name_tw:'素盞嗚尊', name_en:'Susano-o',      rarity:5,                grade:82, icon:'hakaisin_susanoo.png', skills:["Assassin","Mortal Jihad","Kusanagi"], skill4:["Strength Amp III","Killing Wind","Charge","Merciless Blow","Drain Elec"], skill5:["","Diarahan","Hellfire","Fog Breath","Hamadyne"],elements:["Resist","Weak","","","Drain","",""],type:"Attack"            },
