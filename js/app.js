...
const ddd_stable = [
    ...
    },
    {
        ...
        devils:[
            {                name:'Sphinx',     name_tw:'斯芬克斯', name_en:'Sphinx',          rarity:4,                grade:76, icon:'seijyuu_sufuinkusu.png', skills:["Barrier","Tetraka Shift","Mahamaon"], skill4:["Mortal Jihad","Ziodyne","Mediarahan","Auto-Rakukaja","Null Ice"], skill5:["","Ju","Megaton Press","Resist Ice","Evil Gaze"],elements:["","Null","Weak","","","Repel","Weak"], type:"Support"            },
    ...
    },
    {
        ...
        devils:[
            {                name:'Ananta',      name_tw:'阿南塔', name_en:'Ananta',         rarity:5,                grade:83, icon:'ryuuou_ananta.png' , skills:["Diarahan","Auto-Sukukaja","Auto-Rakukaja"], skill4:["Holy Wrath","Mabufudyne","Mahapoismaon","Auto-Taruka","Drain Ice"], skill5:["","Gigantomachia","Deadly Poison","Mazandyne","Resist Force"],elements:["","","Null","Null","Weak","Null",""], type:'Support'           },
    ...
    },
    {
        ...
        devils:[
            ...
            { name:'Nergal', name_tw:'吹號者', name_en:'', rarity:5, grade:82, icon:'Nergal.jpg', skills:['Berserker God','Meslamtaea',"Plague of Babylon"], skill4:['Strength Amp III','Hades Blast','Toxic Sting','Auto-Taruka','Null Light'], skill5:['','Savage Glee','Auto-Sukukaja','Strength Amp III','Resist Ice'], elements:['','Resist','Weak','','','Resist','Repel'], type:'Support'},
