...
const ddd_stable = [
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Kikuri-Hime',     name_tw:'菊理媛', name_en:'Kikuri-Hime',          rarity:4,                grade:60, icon:'tibosin_kikurihime.png', skills:["Lydia","Maragion","Marin Karion"], skill4:["Vitality Amp II","Agidyne","Diarama","Tetra Shift","Resist Dark"],skill5:["","Resist Fire","Mahapoismaon","Power Hit","Rakukaja"], elements:["","","","Weak","Null","","Weak"], type:"Recovery"            },
