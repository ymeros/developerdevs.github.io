...
const ddd_stable = [
    ...
    },
    {
        ...
        devils:[
            {  name:'Huang Long',  name_tw:'黃龍', name_en:'Huang Long',  rarity:5,  grade:88, icon:'ryuusin_kouryu.png' , skills:["Agility Amp II","Pralaya","Five Elements "], skill4:["Life Aid","Spirit Drain","Luster Candy","Speedster","Null Dark"], skill5:["","Magic Amp III","Serial Killer","Hell Gaze","Enduring Soul"],elements:["","Resist","Resist","Resist","Resist","Null",""],type:"Support"   },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Jikokuten',       name_tw:'持國天', name_en:'Jikokuten',        rarity:4,                grade:62, icon:'kisin_jikokuten.png', skills:["Mazanma","Hades Blast","Suppress Stance Drain"], skill4:["Zandyne","Megaton Raid","Mashibabooon","Life Surge","Null Fire"], skill5:["","Binding Claw","Mediarahan","White Noise","Mind Break"],elements:["","","","Weak","Null","Resist",""], type:"Attack"            },
    ...
    },
    {
        ...
        devils:[
            ...
            { name:'Alice', name_tw:'愛麗絲', name_en:'', rarity:5, grade:89, icon:'majin_arisu.png', skills:['Mamudoon','Mudodyne','Die for Me!'], skill4:['Deathtouch','Hell Gaze','Majuon','Dark Amp','Repel Light'], skill5:['','Glacial Blast','Mabufudyne','Resist Curse','Hurricane Slash'], elements:['','','','','','Weak','Repel'], type:'Attack'},
            {   name:'White Rider', name_tw:'白騎士', name_en:'', rarity:4, grade:74, icon:'majin_waitonaito.png', skills:['Ziodyne','White Noise',"God's Bow"], skill4:['Bolt Storm','Deathtouch','Recarmdra','Null Bind','Null Force'], skill5:['','Bufula','Good Aim','Heat Wave','Bufu'], elements:['','','','Drain','Weak','Resist','Resist'], type:'Attack'}
        ]
    },
    {
        name:'Hero',
