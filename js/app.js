...
const ddd_stable = [
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Zaou-Gongen',           name_tw:'濕婆', name_en:'Zaou-Gongen',    rarity:5,                grade:85, icon:'Zaou-Gongen.png' , skills:["Maragidyne","God's Hand","Kongo Zaou"], skill4:["Enduring Soul","Herculean Strike","Rebellion","Fire Amp","Drain Phys"], skill5:["","Strength Amp III","Auto-Tarukaja","Hellfire","Death Counter"],elements:["Null","Repel","","Weak","","Resist","Resist"],type:"Attack"           },
