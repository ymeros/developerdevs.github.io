...
const ddd_stable = [
    ...
    },
    {
        ...
        devils:[
          ...
          { name:'Jeanne', name_tw:'魔女ジャンヌ', name_en:'',rarity:4, grade:65, icon:'Jeanne.png', skills:['Hades Blast','Berserker','Soul Drain'], skill4:['Magic Amp II','Tempest Slash','Dark Sword','Evade','Null Light'], skill5:['','Magic Amp II','Deadly Bondage','Retaliate','Speedster'], elements:['','','','','','Resist','Resist'], type:'Attack'}
        ]
    }
