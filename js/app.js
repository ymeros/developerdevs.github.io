...
const ddd_stable = [
    {
        ...
        devils:[
            ...
            {   name:'Azrael',      name_tw:'阿斯萊爾',    name_en:'Azrael', rarity:4,    grade:67, icon:'daitensi_azuraeru.png', skills:["Tetrakarn","Evil Gaze","Agidyne"], skill4:["Makarakarn","Mudodyne","Foresight","Makara Shift","Null Dark"], skill5:["","Charm Bite","Dekunda","Wild Instinct","Judgement Light"], elements:["Resist","Resist","Weak","","","Repel","Resist"], type:"Support"            },
            {   name:'Sandalphon',   name_tw:'聖達芬',     name_en:'Sandalphon', rarity:4,           grade:61, icon:'daitensi_sandaruhuon.png', skills:["Hamadyne","Zandyne","Auto-Sukuka"], skill4:["Amrita","Mahamaon","Samarecarm","Wild Instinct","Resist Force"],skill5:["","Meposumudi","Counter","Rakunda","Megaton Press"], elements:["Resist","","","Resist","","Repel","Null"], type:"Attack"         },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Lakshmi',         name_tw:'吉祥天', name_en:'Lakshmi',       rarity:5,                grade:85, icon:'megami_rakusyumi.png', skills:["Diarahan","Twister","Lotus Dance"], skill4:["Mana Gain","Killing Wind","Defensive Cry","Insanity","Null Force"], skill5:["","Ziodyne","Auto-Rakunda","Null Weak","Evil Gaze"], elements:["","","","","Weak","Resist","Null"], type:"Support"            },
            {                name:'Ishtar',        name_tw:'伊絲塔', name_en:'Ishtar',       rarity:5,                grade:82, icon:'megami_isyutaru.png', skills:["Mahamaon","Diarahan","Mesopotamian Star"], skill4:["Samarecarm","Thunderclap","Concentrate","Tetraka Shift","Null Force"], skill5:["","Ice Age","Mahamarin Karion","Dmg Panel Immunity","Resist Dark"],elements:["","","","Null","Weak","Null","Weak"], type:"Recovery"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Jatayu',         name_tw:'佳塔由', name_en:'Jatayu',      rarity:3,                grade:44, icon:'reityou_jatayu.png', skills:["Sukukaja","Auto-Sukuka","Dekaja"], skill4:["Sukunda","Deathbound","Recarm","Wild Instinct","Resist Elec"],skill5:["","Mazan","Madness","Meposumudi","Cursedi"], elements:["","Resist","","Weak","Drain","Null","Weak"], type:"Support"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Amaterasu',      name_tw:'天照', name_en:'Amaterasu',         rarity:5,                grade:82, icon:'majin_amaterasu.png', skills:["Maragion","Tarunda","Tenson Kourin"], skill4:["Auto-Sukuka","Trisagion","Mediarahan","Magic Amp III","Null Elec"], skill5:["","Luck Amp III","Null Charm","Mahamadyne","Mahamakajamaon"],elements:["","Repel","","Weak","","Resist",""], type:"Support"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Kresnik',      name_tw:'克雷斯尼克', name_en:'Kresnik',         rarity:3,                grade:49, icon:'genma_kurusuniku.png', skills:["Sukunda","Null Elec","Judgement Light"], skill4:["Mana Aid","Tempest Slash","Rebellion","Merciless Blow","Null Dark"], skill5:["","Vitality Amp I","Mamudo","Retaliate","Good Aim"],elements:["","","","","Weak","Null",""],type:"Attack"            },
            {                name:'Tam Lin',        name_tw:'塔姆林', name_en:'Tam Lin',       rarity:3,                grade:40, icon:'genma_tamurin.png', skills:["Fast Recovery","Wind Breath","Dark Sword"], skill4:["Hamadyne","Deathbound","Mediara","Tetraka Shift","Resist Fire"], skill5:["","Mazan","Maragi","Lunge","Cleave"],elements:["","","","","","Resist","Weak"],type:"Attack"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Beiji-Weng',    name_tw:'北斗星君', name_en:'Beiji-Weng',           rarity:4,                grade:69, icon:'hakaisin_hokutoseikun.png', skills:["Ice Boost","Bufudyne","Glacial Blast"], skill4:["Recarm","Mabufudyne","Judgement","Null Curse","Repel Ice"], skill5:["","Resist Light","Mazan","Bufu","Madness"],elements:["","Weak","Null","","","Resist",""],type:"Attack"            },
            {                name:'Wu Kong',  name_tw:'齊天大聖', name_en:'Wu Kong',             rarity:4,                grade:61, icon:'hakaisin_seitentaisei.png', skills:["Phys Boost","Taunt","Oni-Kagura"], skill4:["Charge","Titanomachia","Blood Rush","Vitality Amp III","Null Phys"], skill5:["","Thunderclap","Hell Gaze","Maragi","Deadly Poison"],elements:["Resist","Resist","","Weak","Resist","Resist","Weak"],type:"Attack"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {  name:'Gucumatz',  name_tw:'庫庫爾坎', name_en:'Gucumatz',  rarity:4,  grade:69, icon:'ryuusin_gukumatu.png' , skills:["Heat Wave","Ice Breath","Auto-Tarunda"], skill4:["Wild Guess","Wind Breath","Fog Breath","Tetraka Shift","Null Fire"], skill5:["","Berserker God","Tarunda","Retaliate","Mediara"],elements:["","Weak","Resist","","Resist","",""],type:"Support"   },
    ...
    },
    {
        ...
        devils:[
            { name:'Asherah', name_tw:'亞舍拉',name_en:'Asherah', rarity:5, grade:83, icon:'tibosin_asyerato.png', skills:["Mediarama","Mother's Creation","Maragion"], skill4:["Sea of Chaos","Trisagion","Silent Prayer","Recovery Amp","Repel Ice"], skill5:["","Vitality Amp III","Null Bind","Luck Amp III","Resist Dark"],elements:["","Null","Weak","","Null","","Weak"], type:"Recovery"            },
            ...
            { name:'Kikuri-Hime', name_tw:'菊理媛',name_en:'Kikuri-Hime', rarity:4, grade:60, icon:'tibosin_kikurihime.png', skills:["Lydia","Maragion","Marin Karion"], skill4:["Vitality Amp II","Agidyne","Diarama","Tetraka Shift","Resist Dark"],skill5:["","Resist Fire","Mahapoismaon","Power Hit","Rakukaja"], elements:["","","","Weak","Null","","Weak"], type:"Recovery"            },
    ...
    },
    {
        ...
        devils:[
            { name:'Thor',          name_tw:'索爾', name_en:'Thor',     rarity:5,                grade:83, icon:'kisin_toru.png', skills:["Megaton Raid","Charge","Mjolnir"], skill4:["Maziodyne","Gigantomachia","Rebellion","Elec Pierce","Repel Fire"], skill5:["","Mahamadyne","Auto-Rakuka","Elec Boost","Resist Force"],elements:["Resist","Null","","Drain","Weak","Resist",""], type:"Attack"            },
            { name:'Zhong Kui',        name_tw:'鍾馗', name_en:'Zhong Kui',       rarity:4,                grade:75, icon:'kisin_syouki.png', skills:["Hellish Mask","Auto-Taruka","Oni-Kagura"], skill4:["Null Mute","Megaton Raid","Blood Rush","Intimidating Stance","Resist Phys"], skill5:["","Mamudodyne","Dmg Panel V II","Deadly Mute","Mahamaon"],elements:["","Resist","","","Weak","Resist",""], type:"Attack"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Virtue',    name_tw:'力天使', name_en:'Virtue',           rarity:3,                grade:47, icon:'tensi_vatya.png', skills:["Meclosedi","Null Mute","Hamaon"], skill4:["Barrier","Judgement Light","Concentrate","Auto-Sukuka","Null Ice"], skill5:["","Mazio","Agi","Luck Amp I","Agility Amp I"],elements:["","","","Weak","Null","Null","Weak"], type:"Recovery"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Orochi',    name_tw:'八岐大蛇', name_en:'Orochi',           rarity:4,                grade:61, icon:'ryuuou_yamatanooroti.png', skills:["Bufudyne","Megaton Press","Dmg Panel Immunity"], skill4:["Barrier","Agidyne","Recarmdra","Auto-Taruka","Null Light"], skill5:["","Dmg Panel V I","Dekaja","Spirit Drain","Savage Glee"],elements:["","Null","Null","Weak","","",""], type:"Attack"            },
    ...
    },
    {
        ...
        devils:[
            {                name:'Cerberus',     name_tw:'地獄犬', name_en:'Cerberus',          rarity:4,                grade:61, icon:'majyuu_keruberosu.png', skills:["Agidyne","Hell Claw","War Cry"], skill4:["Life Gain","Fire Breath","War Dance","Back Attack","Resist Phys"], skill5:["","Deadly Bondage","Counter","Heat Wave","Agility Amp I"],elements:["","Repel","Weak","","","",""], type:'Attack'            },
    ...
    },
    {
        ...
        devils:[
            {                name:'Oberon',        name_tw:'奧伯隆',  name_en:'Oberon',      rarity:4,                grade:67, icon:'yousei_oberon.png', skills:["Force Boost","Zandyne","Mahamarin Karion"], skill4:["Makarakarn","Twister","Mecharmdi","Auto-Sukuka","Resist Ice"], skill5:["","Cleave","Vitality Amp I","Tarukaja","Spirit Drain"],elements:["","","","Weak","Drain","",""], type:"Attack"            },
            {                name:'Titania',    name_tw:'提泰妮婭', name_en:'',           rarity:4,                grade:62, icon:'yousei_teitania.png', skills:["Elec Boost","Mazionga","Makajamaon"], skill4:["Mana Gain","Bolt Storm","Prayer","Back Attack","Resist Phys"], skill5:["","Tarunda","Mamudo","Fatal Sword","Shock"],elements:["","","","","","Resist","Resist"], type:"Support"            },
    ...
    },
    {
        ...
        devils:[
            {                name:'Fenrir',    name_tw:'芬里爾', name_en:'',           rarity:4,                grade:61, icon:'youjyuu_huenriru.png', skills:["Nihil Claw","Agility Amp II","Auto-Taruka"], skill4:["Eat Whole","Hades Blast","Makara Break","Speedster","Resist Force"], skill5:["","Resist Dark","Eat Whole","Meweakdi","Hama"],elements:["","Weak","Drain","Resist","Weak","",""], type:"Support"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Blob',           name_tw:'果凍怪', name_en:'',    rarity:2,                grade:20, icon:'gedou_burobu.png', skills:["Poisma","Zan","Mazan"], skill4:["Tarunda","Spirit Drain","Mahapoisma","Madness","Resist Force"], skill5:["","Weakdi","Bufu","Mamudo","Zio"],elements:["Resist","","Weak","","","Weak","Null"],type:"Support"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Surt',         name_tw:'史爾特爾', name_en:'',     rarity:5,                grade:83, icon:'maou_suruto.png', skills:["Berserker God","Tetraka Shift","Ragnarok"], skill4:["Intimidating Stance","Maragidyne","Rattle","Fire Pierce","Null Ice"], skill5:["","Hellfire","Magic Amp III","Fire Boost","Eat Whole"],elements:["","Drain","Weak","","","",""], type:'Attack'            },
            {                name:'Loki',           name_tw:'洛基', name_en:'',    rarity:4,                grade:75, icon:'maou_roki.png', skills:["Zandyne","Agidyne","Trickster"], skill4:["Ziodyne","Bufudyne","Mind Blast","Void Dark Zones","Resist Light"], skill5:["","Bloody Glee","Eat Whole","Mamudoon","Mudoon"],elements:["","","Null","","Resist","Weak","Resist"], type:'Attack'           },
            {                name:'Beelzebub',     name_tw:'別西卜', name_en:'',          rarity:4,                grade:68, icon:'maou_beruzebubu.png', skills:["Mudodyne","Mazionga","Gluttony"], skill4:["Wild Instinct","Bolt Storm","Sea of Chaos","Makara Shift","Repel Light"], skill5:["","Madezoreton","Resist Phys","Bloody Glee","Resist Elec"],elements:["","","","Resist","Resist","Null","Null"], type:'Attack'            },
            ...
            {                name:'Abaddon',       name_tw:'阿巴頓', name_en:'',        rarity:4,                grade:60, icon:'maou_abadon.png', skills:["Retaliate","Maragion","Binge Eating"], skill4:["Hellfire","Megaton Raid","Acid Breath","Bloody Glee","Null Phys"], skill5:["","Agility Amp I","Hellish Mask","Ju","Meclosedi"],elements:["","Repel","","Weak","","",""], type:'Attack'            },
            {                name:'Horkos',       name_tw:'奧迦斯', name_en:'',        rarity:3,                grade:46, icon:'maou_okasu.png', skills:["Endure","Retaliate","Hellfire"], skill4:["Auto-Rakuka","Power Hit","Tetra Break","Vitality Amp II","Null Ice"], skill5:["","Mabufu","Zan","Wild Guess","Fast Recovery"],elements:["Resist","","Weak","","","Weak",""], type:'Attack'            }
        ]
    },
    {
        name:'Haunt',
    ...
    },
    {
        ...
        formulas:[],
        devils:[
            { name:'Mother Harlot', name_tw:'吹號者', name_en:'', rarity:5, grade:95, icon:'Mother-Harlot.png', skills:['Mana Gain','Death Lust',"Babylon Goblet"], skill4:['Magic Amp III','Deathtouch','Debilitate','Deadly Charm','Drain Phys'], skill5:['','Tetraka Shift','Infernal Mask','Insanity','Makara Shift'], elements:['Null','','','Drain','Weak','Resist','Resist'], type:'Support'},
            { name:'Trumpeter', name_tw:'吹號者', name_en:'', rarity:5, grade:94, icon:'majin_toranpeta.png', skills:['Concentrate','Soul Drain',"Apocalypse"], skill4:['Mahamakajamaon','Judgement','Demon Birth Cry','Auto-Rakuka','Resist Phys'], skill5:['','Evade','Auto-Tarunda','Trisagion','Resist Fire'], elements:['','','','','','Null','Null'], type:'Attack'},
            ...
            { name:'Hell Biker', name_tw:'白騎士', name_en:'', rarity:4, grade:77, icon:'Hell-Biker.png', skills:['Maragion','Speedster',"Red Zone"], skill4:['Power Hit','Mamudoon','Recarmdra','Auto-Sukuka','Repel Light'], skill5:['','Agidyne','War Cry','Deadly Bondage','Resist Dark'], elements:['','Repel','','','Resist','Weak',''], type:'Attack'},
    ...
    },
    {
        ...
        formulas:[],
        devils:[
            { name:'Yoshitsune', name_tw:'義經', name_en:'', rarity:5, grade:97, icon:'eiyuu_yositune.png', skills:['Vorpal Blade','Mana Aid','Hassou Tobi'], skill4:['Enduring Soul','Gigantomachia','Charge','Phys Amp','Drain Phys'], skill5:['',"God's Hand",'Auto-Sukuka','Savage Glee','Resist Ice'], elements:['Resist','','','','','Null','Null'], type:'Attack'},
            { name:'Huang Di', name_tw:'皇帝', name_en:'', rarity:5, grade:88, icon:'eiyuu_koutei.png', skills:['Hades Blast','Superior Power','Yinlong Killer'], skill4:['Life Aid','Berserker God','Salvation','Null Charm','Repel Light'], skill5:['','Auto-Taruka','Null Phys','Serial Killer','Infernal Mask'], elements:['','Resist','Resist','Resist','Resist','',''], type:'Attack'},
    ...
    },
    {
        ...
        formulas:[],
        devils:[
            { name:'Reiko Kashima', name_tw:'啃咬魔', name_en:'', rarity:3, grade:42, icon:'Reiko.png', skills:['Mudo','Lunge','Youre Next'], skill4:['Null Curse','','','',''], skill5:['','','','',''], elements:['','Weak','','','','Weak','Drain'], type:'Attack \u00A0\u00A0 | Herald Lailah + Enigma Kanbari + Kishin Take-Minakata |'},
            { name:'Kamiotoko', name_tw:'啃咬魔', name_en:'', rarity:2, grade:25, icon:'kaii_kamiotoko.png', skills:['Mudoon','Insanity','Paralyzing Bite'], skill4:['War Cry','','','',''], skill5:['','','','',''], elements:['','','','','','Weak','Repel'], type:'Support \u00A0\u00A0 | Foul Phantom + Haunt Obariyon + Haunt Mou-Ryo |'}
        ]
    },
    {
        name:'UMA',
        ...
        formulas:[],
        devils:[
            { name:'Hare of Inaba', name_tw:'因幡白兔', name_en:'',rarity:3, grade:41, icon:'tinjyuu_inabasirousagi.png', skills:['Dekaja','Media','Trap Free'], skill4:['Recarm','','','',''], skill5:['','','','',''], elements:['','Weak','','','','',''], type:'Recovery \u00A0\u00A0 | Beast Nekomata + Night Fomorian + Avatar Makami |'},
            { name:'Chupacabra', name_tw:'卓柏卡布拉', name_en:'',rarity:1, grade:15, icon:'tinjyuu_typakabura.png', skills:['Mazan','Stealth','Trap Free'], skill4:['Auto-Sukuka','','','',''], skill5:['','','','',''], elements:['','','','Weak','','',''], type:'Attack \u00A0\u00A0 | Foul Slime + Fallen Melchom + Wilder Chagrin |'}
        ]
    },
    {
        name:'Enigma',
        ...
        formulas:[],
        devils:[
            { name:'Kama', name_tw:'伽摩', name_en:'',rarity:4, grade:75, icon:'hisin_kama.png', skills:['Speedster','Dekunda',"Divine Bows' Allure"], skill4:['Vorpal Blade','','','',''], skill5:['','','','',''], elements:['Resist','Weak','','','','Resist',''], type:'Support \u00A0\u00A0 | Femme Yaksini + Deity Mitra + Femme Dakini + Femme Rangda |'},
            { name:'Kinmamon', name_tw:'君真物', name_en:'',rarity:3, grade:55, icon:'hisin_kinmamon.png', skills:['Megido','Barrier','Mutant'], skill4:['Megidola','','','',''], skill5:['','','','',''], elements:['','Null','Weak','','','Resist','Resist'], type:'Support \u00A0\u00A0 | Holy Heqet + Haunt Legion + Wilder Mothman + Vile Arahabaki |'},
            { name:'Kanbari', name_tw:'加牟波理', name_en:'',rarity:2, grade:30, icon:'hisin_kanbari.png', skills:['Rampage','Hamaon','Luck'], skill4:['Megaton Press','','','',''], skill5:['','','','',''], elements:['Weak','','','','','Resist','Weak'], type:'Attack \u00A0\u00A0 | Yoma Koppa Tengu + Genma Kurama Tengu + Beast Inugami + Femme Shikome |'}
        ]
    },
    {
        name:'Zealot',
        ...
        formulas:[],
        devils:[
            { name:'Attis', name_tw:'阿提斯', name_en:'',rarity:4, grade:65, icon:'kyousin_ateisu.png', skills:['Enduring Soul','Recarmdra','Mist Slashes'], skill4:['Life Aid','','','',''], skill5:['','','','',''], elements:['Resist','','','','','',''], type:'Attack \u00A0\u00A0 | Megami Arianrhod + Vile Baphomet + Lady Isis + Brute Berserker |'},
