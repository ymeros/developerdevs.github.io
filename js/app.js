...
const ddd_stable = [
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Suparna',         name_tw:'金翅鳥', name_en:'Suparna',      rarity:2,                grade:28, icon:'reityou_suparuna.png', skills:["Zio","Vajra Blast","Rakukaja"], skill4:["Diara","Spirit Drain","Tarunda","Hellish Mask","Null Elec"],skill5:["","Closedi","Good Aim","Mudo","Lunge"], elements:["","","","Resist","","Resist","Weak"], type:"Attack"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Shiki-Ouji',       name_tw:'式王子', name_en:'',        rarity:3,                grade:49, icon:'youki_sikiouji.png', skills:["Resist Mute","Hama","Mudo"], skill4:["Dekaja","Megido","Rakunda","Back Attack","Resist Ice"], skill5:["","Meweakdi","Maragi","Curse","Dia"],elements:["Null","Weak","Weak","","","Resist","Resist"], type:"Attack"            },
            {                name:'Ikusa',     name_tw:'黃泉軍', name_en:'',          rarity:3,                grade:41, icon:'youki_yomotuikusa.png', skills:["Resist Poison","Ice Breath","Mamudoon"], skill4:["Merciless Blow","Hurricane Slash","Juon","Savage Glee","Resist Light"], skill5:["","Closedi","Vitality Amp I","Mecursedi","Meweakdi"],elements:["","","","","Weak","Weak","Resist"], type:"Attack"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Shikome',    name_tw:'黃泉醜女', name_en:'',           rarity:2,                grade:23, icon:'kijyo_yomotusikome.png', skills:["Tarunda","Toxic Sting","Bufula"], skill4:["Binding Claw","Darkbound","Weakdi","Dodge","Resist Force"], skill5:["","Lunge","Agi","Paraladi","Zan"],elements:["","Weak","","","","Weak","Resist"] , type:"Support"           },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Girimekhala',    name_tw:'獨眼魔象', name_en:'',           rarity:4,                grade:67, icon:'jyasin_girimekara.png', skills:["Resist Dark","Mega Boost","Megaton Press"], skill4:["Bind Voice","Binge Eating","Rakunda","Savage Glee","Resist Force"], skill5:["","Judgement Light","Agidyne","Closedi","Bufula"],elements:["Repel","","","Weak","Weak","Weak",""], type:'Attack'            },
...
const skill_stable = [
    ...
    },
    {
        ...
        skills:[
            ...
            {"name":"Mahashibabooon","name_tw":"瑪哈希巴縛翁","desc":"40% chance to inflict Bind on All Enemies.","mp":7,"point":null,"element":"Null"},
            ...
            {"name":"Mahamakajaon","name_tw":"瑪哈瑪卡加瑪翁","desc":"40% chance to inflict Mute on All Enemies.","mp":7,"point":9,"element":"Null"},
