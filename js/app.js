...
const ddd_stable = [
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Ares',           name_tw:'阿瑞斯', name_en:'Ares',    rarity:3,                grade:44, icon:'hakaisin_aresu.png', skills:["Herculean Strike","Counter","Hellfire"], skill4:["Dekunda","Berserker God","Charge","Bloody Glee","Resist Phys"], skill5:["","Hellish Mask","Sexy Dance","Shibabooon","Rampage"],elements:["","","","","","Resist","Weak"],type:"Attack"            }
        ]
    },
    {
        name:'Dragon',
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Setanta',        name_tw:'瑟坦特', name_en:'',       rarity:3,                grade:47, icon:'yousei_setanta.png', skills:["Oni-Kagura","Great Aim","Herculean Strike"], skill4:["Darkbound","Zanma","Tarukaja","Berserker","Resist Elec"], skill5:["","Vitality Amp I","Zio","Cursedi","Heat Wave"],elements:["","","","Weak","Null","","Weak"], type:"Attack"           },
