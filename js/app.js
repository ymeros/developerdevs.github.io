...
const ddd_stable = [
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Naga',        name_tw:'那迦', name_en:'Naga',       rarity:2,                grade:28, icon:'ryuuou_naga.png', skills:["Fatal Sword","Bufula","Good Aim"], skill4:["Rebellion","Deathbound","Desolate","Life Gain","Null Ice"], skill5:["","Lunge","Dodge","Meposumudi","Heat Wave"],elements:["","Weak","Resist","Resist","Weak","","Weak"], type:"Attack"            },
