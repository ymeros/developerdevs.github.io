...
const ddd_stable = [
    {
        ...
        devils:[
            ...
            {   name:'Michael',        name_tw:'米迦勒', name_en:'Michael',      rarity:5,    grade:90, icon:'daitensi_mikaeru.png', skills:["Life Aid","Soul Mind Break","Megidolaon"], skill4:["Endure","Thunderclap","Mediarahan","Hellish Mask","Repel Dark"], skill5:['','Titanomachia','Resist Fire','Ziodyne','Hurricane Slash'], elements:["","","Null","Null","","Repel","Weak"], type:"Attack"     },
            {   name:'Mastema',        name_tw:'莫塞瑪特', name_en:'Mastema',     rarity:5,    grade:83, icon:'daitensi_mansemato.png', skills:["Mind Break Light","Bind Voice","Ordeal of Hatred"], skill4:["Mana Gain","Ice Age","Makajamaon","Light Amp","Repel Ice"], skill5:['','Deadly Wind','Madness','Hamadyne','Resist Elec'], elements:["","Weak","Null","","Repel","Repel",""], type:"Attack"     },
            {   name:'Azrael',      name_tw:'阿斯萊爾',    name_en:'Azrael', rarity:4,    grade:67, icon:'daitensi_azuraeru.png', skills:["Tetrakarn","Evil Gaze","Agidyne"], skill4:["Makarakarn","Mudodyne","Curse","Makara Shift","Null Dark"], skill5:["","Charm Bite","Dekunda","Wild Instinct","Mind Break Light"], elements:["Resist","Resist","Weak","","","Repel","Resist"], type:"Support"            },
    ...
    },
    {
        ...
        devils:[
            {                name:'Lakshimi',         name_tw:'吉祥天', name_en:'Lakshimi',       rarity:5,                grade:85, icon:'megami_rakusyumi.png', skills:["Diarahan","Twister","Lotus Dance"], skill4:["Mana Gain","Deadly Wind","Makarakarn","Insanity","Null Force"], skill5:["","Charm Bite","Ziodyne","Null Weak","Toxic Sting"], elements:["","","","","Weak","Resist","Null"], type:"Support"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Anubis',       name_tw:'阿努比斯', name_en:'Anubis',        rarity:4,                grade:70, icon:'sinjyuu_anubisu.png', skills:["Dark Boost","Mudodyne","Mind Break Light"], skill4:["Dekunda","Purgatory","Tetrakarn","Merciless Blow","Null Dark"], skill5:["","Spirit Drain","Poisma","Dia","Agilao"],elements:["","","","","","Null","Resist"],type:"Attack"            },
    ...
    },
    {
        ...
        devils:[
            {                name:'Cu Chulainn',    name_tw:'庫夫林', name_en:'Cu Chulainn',           rarity:5,                grade:81, icon:'genma_kuhurin.png', skills:["Savage Glee","Mazandyne","Gae Bolg"], skill4:["Rebellion","Deadly Wind","Recarmdra","Force Pierce","Repel Dark"], skill5:["","Megidola","Makajam","Darkbound","Ice Age"],elements:["Resist","","","","Null","",""],type:"Attack"            },
            ...
            {                name:'Hanuman',        name_tw:'哈奴曼', name_en:'Hanuman',       rarity:4,                grade:60, icon:'genma_hanuman.png', skills:["Resist Phys","Vorpal Blade","Mazanma"], skill4:["Madness Nails","Zandyne","Taunt","Retaliate","Repel Force"], skill5:["","Vitality Amp I","Evil Gaze","Mind Break Light","Resist Weak"],elements:["","","","Weak","Null","",""],type:"Attack"            },
            {                name:'Kresnik',      name_tw:'克雷斯尼克', name_en:'Kresnik',         rarity:3,                grade:49, icon:'genma_kurusuniku.png', skills:["Sukunda","Null Elec","Mind Break Light"], skill4:["Mana Aid","五月雨斬","リベリオ","Merciless Blow","Null Dark"], skill5:["","Vitality Amp I","Mamudo","Retaliate","Good Aim"],elements:["","","","","Weak","Null",""],type:"Attack"            },
    ...
    },
    {
        ...
        devils:[
            {   name:'Asherah',    name_tw:'亞舍拉', name_en:'Asherah', rarity:5,        grade:83, icon:'tibosin_asyerato.png', skills:["Mediarama","Samarecarm","Maragion"], skill4:["Sea of Chaos","Ragnarok","Silent Prayer","Heal Amp","Repel Ice"], skill5:["","Mind Break Light","Hellish Mask","Luck Amp II","Deadly Bondage"],elements:["","Null","Weak","","Null","","Weak"], type:"Recovery"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Virtue',    name_tw:'力天使', name_en:'Virtue',           rarity:3,                grade:47, icon:'tensi_vatya.png', skills:["Meclosedi","Null Mute","Hamaon"], skill4:["Barrier","Mind Break Light","Concentrate","Auto-Sukukaja","Null Ice"], skill5:["","Mazio","Agi","Luck Amp I","Agility Amp I"],elements:["","","","Weak","Null","Null","Weak"], type:"Recovery"            },
            ...
            {                name:'Principality',   name_tw:'權天使', name_en:'Principality',            rarity:2,                grade:35, icon:'tensi_purinsiparitei.png', skills:["Recarm","Hamaon","Bufu"], skill4:["Media","Mind Break Light","Cursedi","Light Boost","Resist Dark"], skill5:["","Magic Amp I","Meweakdi","Dmg Panel V I","Mazan"], elements:["","","","","","Null","Weak"], type:"Recovery"            },
            ...
            {                name:'Angel',         name_tw:'Divine', name_en:'Angel',      rarity:2,                grade:20, icon:'tensi_enjyeru.png', skills:["Hama","Mahama","Diara"], skill4:["Rakukaja","Mind Break Light","Charmdi","Null Mute","Resist Elec"], skill5:["","Closedi","Agi","Mecharmdi","Mabufu"],elements:["","","","Weak","","Null","Weak"], type:"Recovery"            }
        ]
    },
    {
        name:'Yoma',
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Kelpie',        name_tw:'凱爾皮', name_en:'',       rarity:2,                grade:35, icon:'yousei_kerupi.png', skills:["Diara","Zionga","Rampage"], skill4:["Void Dark Zones","Spirit Drain","Redia","Wild Guess","Resist Dark"], skill5:["","Good Aim","Mazio","Good Aim","Zio"],elements:["","","Resist","","Weak","",""], type:"Recovery"            },
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Girimehkala',    name_tw:'獨眼魔象', name_en:'',           rarity:4,                grade:67, icon:'jyasin_girimekara.png', skills:["Resist Dark","Mega Boost","Megaton Press"], skill4:["Bind Voice","Binge Eating","Rakunda","Savage Glee","Resist Force"], skill5:["","Mind Break Light","Agidyne","Closedi","Bufula"],elements:["Repel","","","Weak","Weak","Weak",""], type:'Attack'            },
    ...
    },
    {
        ...
        devils:[
            {                name:'Lucifer',     name_tw:'露西法', name_en:'',          rarity:5,                grade:98, icon:'maou_rusifua.png', skills:["Megidolaon","Ragnarok","Morning Star"], skill4:["Vitality Amp III","Titanomachia","Recarmdra","Butcher","Drain Light"], skill5:["","Mudodyne","Null Charm","Elec Boost","Marin Karion"],elements:["Resist","","","","","Weak","Repel"], type:'Attack'            },
    ...
    },
    {
        ...
        devils:[
            {                name:'Vetala',        name_tw:'毘陀羅', name_en:'',       rarity:3,                grade:55, icon:'yuuki_vetara.png', skills:["Redia Break","Bufudyne","Eat Whole"], skill4:["Rampage","Energy Drain","Acid Breath","Resist Poison","Resist Fire"], skill5:["","Cursedi","Agility Amp I","Heat Wave","Agility Amp I"],elements:["","Weak","","","","Weak","Null"], type:"Attack"            },
    ...
    },
    {
        ...
        devils:[
            ...
            { name:'Siegfried', name_tw:'齊格飛', name_en:'', rarity:5, grade:83, icon:'eiyuu_jikuhurito.png', skills:['Berserker God','Rebellion','Arms Mastery'], skill4:['Life Aid','Titanomachia','Charge','Enduring Soul','Null Force'], skill5:['','Maziodyne','Ragnarok','Megidola','Evil Gaze'], elements:['Drain','','','','','',''], type:'Attack'},
...
const skill_stable = [
    ...
    },
    {
        ...
        skills:[
            ...
            {"name":"Bolt Storm","name_tw":"衝擊波","desc":"ランダムな敵に２〜４回、電撃属性の魔法型ダメージを威力50で与える。","mp":5,"point":10,"element":"Elec"},
    ...
    },
    {
        ...
        skills:[
            ...
            {"name":"Mind Break Light","name_tw":"審判之光","desc":"敵ランダムに２～４回、破魔属性の魔法型ダメージを威力40で与える。","mp":7,"point":7,"element":"Light"},
            ...
            {"name":"Soul Mind Break","name_tw":"斷罪刑魂","desc":"ランダムな敵に7回、破魔属性の魔法型ダメージを威力30で与える。","mp":5,"point":null,"element":"Light"}
        ]
    },
    {
        name:"Dark",
        ...
        skills:[
            ...
            {"name":"Hell Gaze","name_tw":"Hell Gaze","desc":"敵単体に呪殺属性の魔法型ダメージを威力180で与える。","mp":7,"point":12,"element":"Dark"},
            ...
            {"name":"Die for Me!","name_tw":"可以為我而死嗎？","desc":"敵単体を死亡させる。","mp":7,"point":null,"element":"Dark"}
        ]
    },
    {
        name:"Almighty",
        ...
        skills:[
            //萬
            {"name":"Life Drain","name_tw":"Life Drain","desc":"敵単体に万能属性の魔法型ダメージを威力120で与え、そのダメージの25％分、自身を回復する。","mp":5,"point":3,"element":"Almighty"},
            {"name":"Deathtouch","name_tw":"死亡之觸","desc":"敵単体に万能属性の魔法型ダメージを威力140で与え、そのダメージの40％分、自身を回復する。","mp":6,"point":6,"element":"Almighty"},
            {"name":"Spirit Drain","name_tw":"Spirit Drain","desc":"敵単体に万能属性の魔法型ダメージを威力100で与え、MPを１奪う。","mp":6,"point":3,"element":"Almighty"},
            {"name":"Energy Drain","name_tw":"能量抽取","desc":"敵単体に万能属性の魔法型ダメージを威力120で与え、そのダメージの25%分、自身を回復し、MPを1奪う。","mp":7,"point":6,"element":"Almighty"},
            {"name":"Soul Drain","name_tw":"靈魂抽取","desc":"敵単体に万能属性の魔法型ダメージを威力140で与え、そのダメージの40％分、自身を回復し、MPを１奪う。","mp":8,"point":7,"element":"Almighty"},
            {"name":"Megido","name_tw":"米吉朵","desc":"敵全体に万能属性の魔法型ダメージを威力80で与える。","mp":6,"point":5,"element":"Almighty"},
            {"name":"Megidola","name_tw":"米吉朵拉","desc":"敵全体に万能属性の魔法型ダメージを威力100で与える。","mp":7,"point":8,"element":"Almighty"},
            {"name":"Megidolaon","name_tw":"米吉朵拉翁","desc":"敵全体に万能属性の魔法型ダメージを威力120で与える。","mp":8,"point":"12","element":"Almighty"},
            {"name":"Sea of Chaos","name_tw":"混沌之海","desc":"敵全体に万能属性の魔法型ダメージを威力100で与え、3ターンの間、敵全体の防御力を20%減少させる。","mp":9,"point":null,"element":"Almighty"},
            {"name":"Judgement","name_tw":"審判","desc":"敵全体に万能属性の魔法型ダメージを威力100で与え、3ターンの間、味方全体の攻撃力を20%増加させる。","mp":9,"point":"12","element":"Almighty"},
            {"name":"Mind Break","name_tw":"Mind Break","desc":"敵単体に万能属性の魔法型ダメージを威力80で与え、MPを３失わせる。","mp":5,"point":6,"element":"Almighty"},
            {"name":"Fire of Sinai","name_tw":"西奈的神火","desc":"ランダムな敵に５回、万能属性の魔法型ダメージを威力45で与える。","mp":7,"point":null,"element":"Almighty"},
            ...
            {"name":"Apocalypse","name_tw":"默示錄","desc":"敵全体に万能属性の魔法型ダメージを威力110で与え、基礎確率30％で魔封状態にする。","mp":8,"point":null,"element":"Almighty"},
            {"name":"Morning Star","name_tw":"拂曉明星","desc":"敵全体に万能属性の魔法型ダメージを威力150で与える。","mp":8,"point":null,"element":"Almighty"},
            {"name":"Divine Bows' Allure","name_tw":"魅惑神弓","desc":"敵単体に万能属性の魔法型ダメージを威力190で与え、基礎確率45％で魅了状態にする。","mp":8,"point":null,"element":"Almighty"}
        ]
    },
    {
        name:"Recovery",
    ...
    },
    {
        ...
        skills:[
            ...
            {"name":"Lotus Dance","name_tw":"蓮華之舞","desc":"敵全体を基礎確率60％で魅了状態にする。","mp":6,"point":null,"element":"Null"},
            //封
    ...
    },
    {
        ...
        skills:[
            ...
            {"name":"Repel Phys","name_tw":"物理反射","desc":"物理反射を得る。","mp":null,"point":null,"element":"Passive"},
