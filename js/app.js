...
const ddd_stable = [
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Zhong Kui',        name_tw:'鍾馗', name_en:'Zhong Kui',       rarity:4,                grade:75, icon:'kisin_syouki.png', skills:["Hellish Mask","Auto-Taruka","Oni-Kagura"], skill4:["Null Mute","Megaton Raid","Blood Rush","Intimidating Stance","Resist Phys"], skill5:["","Allure","Dmg Panel V II","Deadly Mute","Mahamaon"],elements:["","Resist","","","Weak","Resist",""], type:"Attack"            },
