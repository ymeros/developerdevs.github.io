...
const ddd_stable = [
    ...
    },
    {
        ...
        devils:[
            ...
            {                name:'Zhong Kui',        name_tw:'鍾馗', name_en:'Zhong Kui',       rarity:4,                grade:75, icon:'kisin_syouki.png', skills:["Hellish Mask","Auto-Taruka","Oni-Kagura"], skill4:["Null Mute","Megaton Raid","Dezoreton","Intimidating Stance","Resist Phys"], skill5:["","Allure","Dmg Panel V II","Deadly Mute","Mahamaon"],elements:["","Resist","","","Weak","Resist",""], type:"Attack"            },
    ...
    },
    {
        ...
        devils:[
            {                name:'Ongyo-Ki',     name_tw:'隱形鬼', name_en:'',          rarity:4,                grade:68, icon:'youki_ongyouki.png', skills:["Dark Sword","Auto-Rakuka","Mabufula"], skill4:["Deathtouch","Nihil Claw","Outbreak","Death Counter","Null Dark"], skill5:["","Counter","Deadly Charm","Luck Amp I","Wind Breath"],elements:["Resist","","Resist","","Resist","Weak",""], type:"Attack"            },
